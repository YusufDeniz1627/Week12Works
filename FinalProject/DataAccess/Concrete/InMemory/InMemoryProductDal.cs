...
namespace DataAccess.Concrete.InMemory
{
    public class InMemoryProductDal : IProductDal
    {
        ...
        public void Delete(Product product)
        {
            ...
            //LİNQ ile yazdıgımız Kod !!=> : Lambda denir aşagıdaki kod foreach döngüsü ile yaptıgımız yapıyor
            productToDelete = _products.SingleOrDefault(p => product.ProductId == p.ProductId);

            //-----------------!!!!!!!!!!!!!!-------
            //LİNQ-Olmadan yazacagımız Kod
            //
        ...
        public void Update(Product product)
        {
            ...
            Product _productToUpdate = null;
            _productToUpdate = _products.SingleOrDefault(p => product.ProductId == p.ProductId);
